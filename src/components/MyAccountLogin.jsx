...
export default function MyAccountLogin() {
  ...
  return (
    <View>
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <View style={{marginLeft: 6}}>
              ...
              {userDetails.email !== '' && (
                <Text style={{color: COLORS.GRAY500}}>{userDetails.email}</Text>
              )}
            </View>
          </View>
          <View>
      ...
      <View>
        <TouchableOpacity
          style={[styles.contaner, styles.boxStyle]}
          onPress={NavigationHandler.bind(this, ROUTES.MYBOOKING)}>
        ...
        <TouchableOpacity
          style={[styles.contaner, styles.boxStyle]}
          onPress={NavigationHandler.bind(this, ROUTES.HELP)}>
        ...
        <TouchableOpacity
          style={[styles.contaner, styles.boxStyle]}
          onPress={NavigationHandler.bind(this, ROUTES.ABOUT)}>
